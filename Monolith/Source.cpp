...
/*
Fixing TYPE OF VALUE

Temas:
Valores por default en una funcion (suma (int a=1, int b=2))
Unary Scope Resolution (::) nos permite utilizar una variable global.
Function overloading para distintos tipos de valores (void print(int x) y void print (double x))

Programas:
Checar todos los numeros del 1 al 100 e imprimir los que sean primos.
Obtener el nombre de un número y Obtener un número de su nombre.
Encontrar todos los numeros del 1 al 1000 en donde la suma de sus factores primos obtenga un número primo (12 = 2,2,3 – 2 + 2 + 3 = 7)
Coin Flip Program
Caliente o Frio (Número 1 al 100
Slot Machine Game
Poker Game: 5 cartas al jugador,
Programa que detecta si los valores de una lista están en orden y si no los ordena.
En conecta 4, bool checar explicar su logica!!
Checar Tictactoe, Conecta 4 y Checkers.
...
6.- TypeofNumbers: Explains what bool, char, int, short, long, signed, unsigned, float and double are and their allowed values.
7.- Classes: 
8.- Loops:
...
void Calculator() {
	...
	if (userSelection == 1) {
		...
		cout << endl <<"Tabla Periodica!" << endl;
		int array[10][10];
...
void TypeofNumbers() {
	...
	char caracter = -59; unsigned char caracter2 = 97; signed char caracter3 = -13;
	int integral = 2147483647; unsigned int integral2 = 4294967295; signed int integral3 = -2147483647;
	short int corto = 32767; unsigned short int corto2 = 65535; signed short int corto3 = -32768; long int largo = sizeof(long);
	float flotante = 3.4e+38F; 	double decimal = 1.7e+308;
	cout << "Booleano: Sus valores son unicamente Verdadero o Falso, los cuales se muestran con el valor numerico binario 1 o 0: [" << boleano << " o " << boleano2 << "]" << endl;
	cout << "Caracter: Es de 1byte y toma valores numericos que corresponden a los simbolos ANSII: [" << caracter << "]\nLos Caracter Unsigned solo puede usar el rango de 0 a 255: " << caracter2 << "\nLos Caracter Signed solo puede usar el rango de -128 a 127: " << caracter3 << "\n" << endl;
	...
	cout << "Un flotante es un valor con (+-7) digitos con un lead de (3.4) de precicion pero utilizando notacion cientifica puede representar numeros de hasta la 37 potencia\n es decir de hasta 37 ceros: " << flotante << "\n" << endl;
...
void ClasesyConstructores() {
	...
	ImprimirNombre ObjetoAuto("Este mensaje fue creado con una clase!, primer se creo una funcion publica para poder introducir el nombre como un argumento de una funcion, finalmente se asigno una funcion void para le mismo string y luego un este se asigno a la variable de nombre completo.");
...
do {
	...
	case 9: programHolder(&OrdenarNumerosArray); break;
	case 10: programHolder(&MenuCocinaSwitch); break;
	case 11: programHolder(&Discount); break;
